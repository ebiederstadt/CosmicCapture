...
DoorSwitchZone::DoorSwitchZone(const ShaderProgram& shaderProgram, std::shared_ptr<Camera> camera) :
	Entity("models/dropoff_zone.ply", "textures/fancy.jpg", shaderProgram, camera)
{
}
...
void DoorSwitchZone::draw(Physics& instance, const ShaderProgram& depthTexture, bool depth, const unsigned& depthMap)
{
